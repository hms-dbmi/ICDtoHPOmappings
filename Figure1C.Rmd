---
title: "7C_Prop_ByUsageGroup_NotAdm"
author: "Amelia"
date: "27 June 2022"
output: html_document
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_dir =paste0("../../Output/7C_Prop_ByUsageGroup_NotAdm/",Sys.Date())) })
---
...
#install.packages("pander")
  ...
  library(ggsci)
  library(ggthemes)
  dir.create(here("Output","7C_Prop_ByUsageGroup_NotAdm"))
  dir.create(here("Output","7C_Prop_ByUsageGroup_NotAdm",Sys.Date()))
  dir.create(here("Output","7C_Prop_ByUsageGroup_NotAdm",Sys.Date(),"Outfiles"))
  PATH_OUT=paste0(here("Output","7C_Prop_ByUsageGroup_NotAdm",Sys.Date(),"Outfiles"),"/")
...
### PLOTING FOR THE 
```{R}
#READ IN THE LIST COMPONENTS THAT ARE FOR NOTADMITTED PATIENTS
  lapply(BIDMC_USAGEDATA[7:9],head)
  lapply(BIDMC_USAGEDATA[1:3],names)
  
  NOTADMITTED_USAGE<-BIDMC_USAGEDATA[1:3]
  names(NOTADMITTED_USAGE)<-c("infrequent","common","rare")
  ...
  common_out<-MAPPEDGROUPS(NOTADMITTED_USAGE[["common"]]$ontologyID)
  common_out$TOPLOT_PROP

  infrequent_out<-MAPPEDGROUPS(NOTADMITTED_USAGE[["infrequent"]]$ontologyID)
  infrequent_out$TOPLOT_PROP
  
  rare_out<-MAPPEDGROUPS(NOTADMITTED_USAGE[["rare"]]$ontologyID)
...
```{R}
  save(
    ...
    file=paste0(here("Output","7C_Prop_ByUsageGroup_NotAdm",Sys.Date()),"/7C_Prop_ByUsageGroup_NotAdm.Rdata")
  )
```
