---
title: "7B_Prop_ByUsageGroup_ICU"
author: "Amelia"
date: "27 June 2022"
output: html_document
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_dir =paste0("../../Output/7B_Prop_ByUsageGroup_ICU/",Sys.Date())) })
---
...
#install.packages("pander")
  ...
  library(ggsci)
  library(ggthemes)
  dir.create(here("Output","7B_Prop_ByUsageGroup_ICU"))
  dir.create(here("Output","7B_Prop_ByUsageGroup_ICU",Sys.Date()))
  dir.create(here("Output","7B_Prop_ByUsageGroup_ICU",Sys.Date(),"Outfiles"))
  PATH_OUT=paste0(here("Output","7B_Prop_ByUsageGroup_ICU",Sys.Date(),"Outfiles"),"/")
...
### PLOTING FOR THE 
```{R}
#READ IN THE LIST COMPONENTS THAT ARE FOR ICU PATIENTS
  lapply(BIDMC_USAGEDATA[4:6],head)
  lapply(BIDMC_USAGEDATA[4:6],names)
  
  ICU_USAGE<-BIDMC_USAGEDATA[4:6]
  names(ICU_USAGE)<-c("infrequent","common","rare")
  ...
  common_out<-MAPPEDGROUPS(ICU_USAGE[["common"]]$ontologyID)
  common_out$TOPLOT_PROP

  infrequent_out<-MAPPEDGROUPS(ICU_USAGE[["infrequent"]]$ontologyID)
  infrequent_out$TOPLOT_PROP
  
  rare_out<-MAPPEDGROUPS(ICU_USAGE[["rare"]]$ontologyID)
...
```{R}
  save(
    ...
    file=paste0(here("Output","7B_Prop_ByUsageGroup_ICU",Sys.Date()),"/7B_Prop_ByUsageGroup_ICU.Rdata")
  )
```
